...
const TagModal = ({ isOpen, onClose, item, onSubmit, isLoading }) => {
  ...
  return (
    <>
      <MasterDataModal isOpen={isOpen} onClose={handleClose} title={item ? 'Edit Tag' : 'Tambah Tag'}>
      ...
      <UnsavedChangesModal
        ...
        description="Form tag ini memiliki perubahan yang belum disimpan. Jika ditutup, semua perubahan akan hilang."
      />
    </>
  );
};
